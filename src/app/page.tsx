...
export default function Home() {
  return (
    <div className="xp-desktop">
      ...
      {/* GitHub Attribution */}
      <a 
        href="https://github.com/catmajor" 
        target="_blank" 
        rel="noopener noreferrer"
        className="xp-attribution"
      >
        <svg className="xp-attribution-icon" viewBox="0 0 16 16" fill="currentColor">
        ...
        <span className="xp-attribution-text">
          ...
          <span className="xp-attribution-name">Nikita Ostapenko '28</span>
